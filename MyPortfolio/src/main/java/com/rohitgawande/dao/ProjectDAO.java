...
public class ProjectDAO {
    ...
    public boolean addProject(Project project) throws SQLException {
        String query = "INSERT INTO projects (title, description, tech_stack, image_url, project_link, github_link) VALUES (?, ?, ?, ?, ?, ?)";
    ...
    public boolean updateProject(Project project) throws SQLException {
        String query = "UPDATE projects SET title = ?, description = ?, tech_stack = ?, image_url = ?, project_link = ?, github_link = ? WHERE id = ?";
